...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.num_pro = QPushButton('%', self)
        self.num_pro.resize(50, 50)
        self.num_pro.move(60, 45)

        self.num_del = QPushButton('//', self)
        self.num_del.resize(50, 50)
        self.num_del.move(115, 45)

        self.num_st = QPushButton('**', self)
        self.num_st.resize(50, 50)
        self.num_st.move(170, 45)
        ...
        self.num_pro.clicked.connect(self.one)
        self.num_del.clicked.connect(self.one)
        self.num_st.clicked.connect(self.one)
